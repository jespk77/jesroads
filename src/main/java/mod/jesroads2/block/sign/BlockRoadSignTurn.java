...
public class BlockRoadSignTurn extends BlockRoadSign implements IBlockSwitchable {
    public enum EnumType implements IStringSerializable {
        LEFT_TURN(0, "left"),
        RIGHT_TURN(1, "right"),
        NO_LEFT_TURN(2, "no_left"),
        NO_RIGHT_TURN(3, "no_right");
    ...
    public BlockRoadSignTurn(int id) {
        ...
        setDefaultState(getDefaultState().withProperty(variant, EnumType.LEFT_TURN));
    }
