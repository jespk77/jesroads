...
public class BlockRoadSignInfo extends BlockRoadSign implements IBlockSwitchable {
	public enum EnumType implements IStringSerializable{
		REST_AREA(0, "rest_area"),
		EXIT(1, "exit"),
		ROADWORKS(2, "roadworks"),
		ROADWORKS_END(3, "roadworks_end");
	...
	public BlockRoadSignInfo(int id){
		...
		setDefaultState(getDefaultState().withProperty(variant, EnumType.REST_AREA));
	}
	...
	public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing enfacing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase entity){
		...
		} else if(!isSupported(world, pos.down(), face)) world.setBlockState(pos.down(), JesRoads2.blocks.signpost.getDefaultState()
