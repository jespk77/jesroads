...
public class BlockRoadSignDetour extends BlockRoadSign implements IBlockSwitchable {
    public enum EnumType implements IStringSerializable {
        DETOUR_LEFT(0, "detour_left"),
        DETOUR_RIGHT(1, "detour_right"),
        DETOUR_UP(2, "detour_up"),
        DETOUR_END(3, "detour_end");
    ...
    public BlockRoadSignDetour(int id) {
        ...
        setDefaultState(getDefaultState().withProperty(variant, EnumType.DETOUR_LEFT));
    }
