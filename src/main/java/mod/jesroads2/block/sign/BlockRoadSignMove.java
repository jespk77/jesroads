...
public class BlockRoadSignMove extends BlockRoadSign implements IBlockSwitchable {
    public enum EnumType implements IStringSerializable {
        LEFT(0, "left"),
        RIGHT(1, "right"),
        RLEFT(2, "roadworks_left"),
        RRIGHT(3, "roadworks_right");
    ...
    public BlockRoadSignMove(int id) {
        ...
        setDefaultState(getDefaultState().withProperty(variant, EnumType.LEFT));
    }
